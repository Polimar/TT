...
import com.valcan.trendytracker.viewmodels.AggiungiScarpaViewModel
...
@Composable
fun AggiungiScarpaScreen(
    navController: NavController,
    viewModel: AggiungiScarpaViewModel = hiltViewModel()
) {
